"""Layer 4 (advisory canary): desklib/ai-text-detector-v1.01.

Supervised DeBERTa detector — best HF-downloadable on RAID. Fails
differently than our heuristics, which is the point. NEVER a gate:
...
def main() -> None:
    ...
    for arg in sys.argv[1:]:
        ...
        body = re.sub(r"^---\n[\s\S]*?\n---\n", "", raw)
        # score in ~700-token chunks and report the mean + worst chunk
        words = body.split()
