...
describe('dramaticInversions (TD-0037)', () => {
...
describe('punchFragments (TD-0037)', () => {
  ...
  // Calibrated 2026-07-15 against the shipped blog corpus (TD-0037): the
  // dispatched "first TWO free" threshold blanket-failed clean posts (Scout's
  // established burstiness texture routinely runs 5-25 short sentences per
  // post). Empirically retuned free-allowance to 10 -- see the calibration
  // comment above the score formula in tone-grader.ts for the full rationale
  // and the before/after corpus numbers.
...
describe('TD-0037 acceptance: a draft in Chad\'s rejected register trips the aiScore<15 gate', () => {
