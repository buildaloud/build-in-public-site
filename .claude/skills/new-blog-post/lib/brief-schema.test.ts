...
const validBrief = {
  ...
  outline: [
    'Why tower defense makes a great agentic coding target',
    'Setting up the Claude Code workflow',
    'Core game loop implementation',
    'What surprised me about AI-assisted game dev',
  ],
  internalLinks: ['https://td.buildaloud.ai', 'https://buildaloud.ai/projects'],
  cta: 'Play the game at td.buildaloud.ai',
  socialBlurb: 'Built a tower defense game with Claude Code last weekend. Here is what agentic coding actually feels like at the limit.',
  imageConcept: 'Isometric pixel-art tower defense map with glowing Claude logo as the command tower',
  marketResearch: [
