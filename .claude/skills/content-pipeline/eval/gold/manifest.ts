...
export const goldBadDefects: SeededDefect[] = [
  {
    id: 'D1',
    description: 'targetKeyword "browser tower defense game" is absent from the seoTitle',
    type: 'wrong',
    difficulty: 'easy',
    layer: 'deterministic',
  ...
  {
    id: 'D3',
    description: 'an internalLink points off the PLAYBOOK allowlist (some-random-unrelated-site.com)',
    type: 'wrong',
    difficulty: 'medium',
    layer: 'deterministic',
  ...
  {
    id: 'D4',
    description: '"change-factory" leaks, buried in an outline beat',
    type: 'wrong',
    difficulty: 'medium',
    layer: 'deterministic',
  ...
  {
    id: 'D7',
    description: 'a limp, generic hook ("In this post, we\'ll explore...") — no Scout voice, no pull',
