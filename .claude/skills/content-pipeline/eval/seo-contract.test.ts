...
// Task 1 (Step-9 gate): binding + forwarding are LLM-prose contracts with no
// prior test. This is a gold-fixture regression seam — it asserts the
// GRADER + FIXTURE shape, not live-LLM obedience at generation time. See
// docs/specs/2026-07-07-phase2a-seo-research-pipeline-design.md §3.
