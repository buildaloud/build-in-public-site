...
`.claude/skills/human-tone/eval/tone-grader.ts` (the signal `formulaic-reviewer`
...
The fixture contains, verbatim, one of the three permabanned phrases (TD-0027)
in `BANNED`:
...
import { scoreText } from '/Users/chadfurman/projects/build-aloud/.claude/skills/human-tone/eval/tone-grader';
...
EOF
npx tsx /tmp/check_banned.ts .claude/skills/content-pipeline/eval/review-fixtures/banned-phrase/trip.draft.md
