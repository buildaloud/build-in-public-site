...
`.claude/skills/human-tone/eval/tone-grader.ts`
**Mode:** draft
...
```bash
npx tsx /tmp/check_banned.ts .claude/skills/content-pipeline/eval/review-fixtures/banned-phrase/clean.draft.md
