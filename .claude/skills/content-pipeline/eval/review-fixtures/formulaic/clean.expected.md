...
"in conclusion" signposting, no hedge phrase. "One Supabase table, one edge
  ...
  "elevations": [
    {
      ...
      "rewrite": "mostly because there was nothing left in it to break except the Supabase connection limit, which we're not close to yet"
    }
  ]
}
```
