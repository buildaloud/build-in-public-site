...
`.claude/agents/voice-reviewer.md` names three things that must be present;
...
3. **Flat held opinions** — "The team" (not "I"), passive "a decision was
   ...
   This is the PERSONALITY.md "Bad" register, not Scout's.
...
```json
{
  ...
  "gateFindings": [
    ...
    },
    {
      ...
      "fix": "state who decided and what, as a held opinion: \"I killed the queue — Cloudflare's retries do the job.\""
    }
  ]
}
```
