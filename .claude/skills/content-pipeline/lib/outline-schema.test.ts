...
const validOutline = {
  ...
  hook: 'I shipped a working tower defense game in a weekend using nothing but Claude Code.',
  emotionalCore: 'the thrill of watching an idea become playable overnight',
  flare: 'a screen recording of the first successful wave clear, unedited',
  ...
  paragraphs: [
    {
      order: 1,
      topic: 'why tower defense is a good agentic coding target',
      goal: 'hook' as const,
      ...
      sources: ['https://buildaloud.ai/projects/tower-defense'],
      keyword: 'agentic coding',
      links: ['https://td.buildaloud.ai'],
