...
description: Judges whether every section of a Build Aloud outline or draft earns its place and lands for this post's audience — purpose, concept, impact, non-redundancy — and returns the shared adversarial-constructive finding schema so weak beats get cut or sharpened.
...
- `docs/specs/2026-07-12-document-review-fanout-design.md` — the army + loops.
- `docs/post-formulas.md` — the Brief should name a `postFormula`; check the shape.
- `docs/paragraph-formulas.md` — each beat should have one named job.
- `PERSONALITY.md` — Scout's voice + who THIS post's audience is.
...
for-your-consideration. ALWAYS offer at least one elevation even when the
