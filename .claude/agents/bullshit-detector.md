...
limit, a misread source, or a mined-source product gap (per [[TD-0031]]) is a
gate finding; this axis is a hard gate (`GATE`). `elevations` are "for your
consideration" — offer at least one even when the piece passes.
